...
def update(connector1, connector2, connector3, connector4, connector5, connector6, connector7, connector8):
    while running:
        ...
        value2 = (data["motor_left"]["position"]+data["motor_right"]["position"])/2
        value3 = data["imu"]["gyro_x_LP"]
        value4 = (data["motor_left"]["velocity_LP"]+data["motor_right"]["velocity_LP"])/2
        value5 = data["kalman"]["out"]["p"]
        value6 = data["kalman"]["out"]["x"]
        value7 = data["kalman"]["out"]["pv"]
        value8 = data["kalman"]["out"]["v"]
